...
{/*           <button
          ...
          <Button type="button" variant="destructive" className="mt-1" onClick={removeAll}>
          Remove all files
        </Button>
          <Button type="submit" variant="blueish" className="ml-auto mt-1" onClick={(e) => uploadImage(e)}>
